...
export class CreateadsComponent implements OnInit {
  ...
  constructor(private _adsservice:AdsService, private router:Router, private _cityservice:CityService, private _localityservice:LocalityService, private _categoryservice:CategoryService, private elem:ElementRef) { }
  ...
  createAdsData(inputData){
    ...
    .subscribe(response => {
     console.log('02', Object.keys(response));
