...
export class UsersService {
  ...
  private _getUsersListUrl = "http://localhost:3000/userslist";
  private _postCreateUsersUrl = "http://localhost:3000/addusedata";
  private _getUsersDataByIdUrl = "http://localhost:3000/updateuse?id=";
  private _postUpdateUsersUrl = "http://localhost:3000/updateusedata?id=";
  private _getDeleteUsersUrl = "http://localhost:3000/deleteusers?id=";
  // private _getUsersListUrl = "http://localhost:3000/userslist";
