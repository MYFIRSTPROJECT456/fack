...
export class CityService {
  ...
  private _getListUrl = "http://localhost:3000/citylist";
  private _postCreateUrl = "http://localhost:3000/addcitydata";
  private _getCityById = "http://localhost:3000/updatecity?cityid=";
  private _postUpdateCity = "http://localhost:3000/updatecitydata?id=";
  private _getDeleteCity = "http://localhost:3000/citydelete?deleteid=";
  private _getListState = "http://localhost:3000/addcity";
  private _postCityByState = "http://localhost:3000/getcitybystate?id=";
