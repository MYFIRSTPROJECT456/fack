...
export class StateService {
  ...
  private _getUrl = "http://localhost:3000/statelist";
  private _postUrl = "http://localhost:3000/statecreate";
  private _getStateById = "http://localhost:3000/update?sid=";
  private _postUpdateState = "http://localhost:3000/updatedata?sid=";
  private _getDeleteState = "http://localhost:3000/delete?sid=";
